...
export default function AuthCreateChangePass() {
  ...
  const [changeEye, setChangeEye] = useState("password");
  ...
  return (
    <div className="min-h-screen flex items-center justify-center font-danaMed select-none">
      <div className="rounded-xl w-96 bg-white shadow-2xl dark:bg-slate-800 flex flex-col justify-center py-5">
        ...
        <p className="pr-8">رمز عبور حداقل باید ۸ حرفی باشد</p>
        ...
        <form className="px-8" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="relative">
            ...
            <div
              onClick={() =>
                changeEye === "text"
                  ? setChangeEye("password")
                  : setChangeEye("text")
              }
              className=" absolute left-2 top-4.5 cursor-pointer"
            >
              {changeEye === "password" ? (
                <Eye size={17} />
              ) : (
